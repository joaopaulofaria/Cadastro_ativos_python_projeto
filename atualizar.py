from menu import validacao_entrada_inteiro, salvar_ativos_json, exibir_tipos, TipoAtivo
...
def atualizar_ativo(ativos):
    ...
    id_consulta = validacao_entrada_inteiro("Digite o ID do ativo: ")
